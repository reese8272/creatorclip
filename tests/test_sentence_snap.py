...
RUN_ON_SEGMENTS = [
    ...
    _segment(
        296.0,
        308.0,
        [("Here", 296.0, 296.4), ("is", 296.5, 296.8), ("the", 296.9, 297.1), ("payoff.", 297.2, 308.0)],
    ),
    _segment(
        310.0,
        330.0,
...
def test_snap_candidates_repairs_end_snapped_before_peak():
    ...
    segments = [
        ...
        _segment(
            95.0,
            130.0,
            [("Then", 95.0, 95.4), ("it", 95.5, 95.7), ("kept", 95.8, 100.0), ("rolling", 100.1, 130.0)],
        ),
    ]
...
def test_snap_start_raw_fallback_beyond_run_on_cap():
    ...
    segments = [
        _segment(
            190.0,
            235.0,
            [("it", 190.0, 190.3), ("just", 190.4, 210.0), ("went", 210.1, 226.0), ("on", 226.1, 235.0)],
        ),
        _segment(
            240.0,
            250.0,

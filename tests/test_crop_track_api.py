...
def test_migration_0055_structure():
    ...
    # Branch-time parent is 0052; the L26 merge step re-parents onto 0054
    # (binding cross-track contract — the comment is the merge instruction).
    assert 'down_revision = "0052"' in src
    assert "re-parent onto 0054" in src

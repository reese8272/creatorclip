...
def _bypass_balance_gate():
    """Issue 228 added a per-creator balance floor on chapter generation. These
    tests assert routing/validation, not billing — neutralize the gate (covered
    in tests/test_creator_quota.py)."""

...
**Active issue**: _(none in flight)_ — Issue 137 code-complete + tests green (2026-06-08); push pending user approval. Issue 136 follow-up (labeled tool rail + hero sign-in CTA) shipped earlier this session.

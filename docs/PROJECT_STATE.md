...
**Active issue**: _(none in flight)_ — Issue 112 code-complete; Locust run is user-side. Pending: user runs Locust on staging VM to close axes A + E, Google OAuth verification, Issue 109 cleanups.
